...
import { userModel, estateModel, cityModel, estate_typeModel, imageModel, estateImageRelModel, staffModel, reviewModel, favoriteModel, energyLabelModel } from '../models/index.js';
...
dbController.get('/seedfromcsv', async (req, res) => {
	try {
		...
		const files_to_seed = [
			...
			{ file: 'estate-type.csv', model: estate_typeModel },
